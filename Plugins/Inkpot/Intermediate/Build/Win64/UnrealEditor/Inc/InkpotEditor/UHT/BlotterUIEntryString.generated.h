...
// IWYU pragma: private, include "Blotter/BlotterUIEntryString.h"

#ifdef INKPOTEDITOR_BlotterUIEntryString_generated_h
#error "BlotterUIEntryString.generated.h already included, missing '#pragma once' in BlotterUIEntryString.h"
#endif
#define INKPOTEDITOR_BlotterUIEntryString_generated_h
...
private: \
	...
	friend INKPOTEDITOR_API UClass* ::Z_Construct_UClass_UBlotterUIEntryString_NoRegister(); \
public: \
	DECLARE_CLASS2(UBlotterUIEntryString, UEditorUtilityWidget, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/InkpotEditor"), Z_Construct_UClass_UBlotterUIEntryString_NoRegister) \
	DECLARE_SERIALIZER(UBlotterUIEntryString) \
...
#define FID_InkpotDemo_Plugins_Inkpot_Source_InkpotEditor_Public_Blotter_BlotterUIEntryString_h_12_ENHANCED_CONSTRUCTORS \
	...
	UBlotterUIEntryString(UBlotterUIEntryString&&) = delete; \
	UBlotterUIEntryString(const UBlotterUIEntryString&) = delete; \
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, UBlotterUIEntryString); \
	DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(UBlotterUIEntryString); \
	DEFINE_DEFAULT_OBJECT_INITIALIZER_CONSTRUCTOR_CALL(UBlotterUIEntryString) \
