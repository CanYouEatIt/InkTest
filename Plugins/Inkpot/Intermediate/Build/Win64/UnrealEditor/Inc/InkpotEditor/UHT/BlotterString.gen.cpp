...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UBlotterString_GetText_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UBlotterString, nullptr, "GetText", 	Z_Construct_UFunction_UBlotterString_GetText_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UFunction_UBlotterString_GetText_Statics::PropPointers), 
sizeof(Z_Construct_UFunction_UBlotterString_GetText_Statics::BlotterString_eventGetText_Parms),
RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UBlotterString_GetText_Statics::Function_MetaDataParams), Z_Construct_UFunction_UBlotterString_GetText_Statics::Function_MetaDataParams)},  };
...
FClassRegistrationInfo Z_Registration_Info_UClass_UBlotterString;
UClass* UBlotterString::GetPrivateStaticClass()
{
	using TClass = UBlotterString;
	if (!Z_Registration_Info_UClass_UBlotterString.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			TClass::StaticPackage(),
			TEXT("BlotterString"),
			Z_Registration_Info_UClass_UBlotterString.InnerSingleton,
			StaticRegisterNativesUBlotterString,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UBlotterString.InnerSingleton;
}
UClass* Z_Construct_UClass_UBlotterString_NoRegister()
{
	return UBlotterString::GetPrivateStaticClass();
}
...
// ********** Begin Class UBlotterString constinit property declarations ***************************
	static const UECodeGen_Private::FTextPropertyParams NewProp_Text;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Class UBlotterString constinit property declarations *****************************
	static constexpr UE::CodeGen::FClassNativeFunction Funcs[] = {
		{ .NameUTF8 = UTF8TEXT("GetText"), .Pointer = &UBlotterString::execGetText },
	};
	static UObject* (*const DependentSingletons[])();
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UBlotterString_GetText, "GetText" }, // 788011154
	};
...
// ********** Begin Class UBlotterString Property Definitions **************************************
...
// ********** End Class UBlotterString Property Definitions ****************************************
...
void UBlotterString::StaticRegisterNativesUBlotterString()
{
	...
	FNativeFunctionRegistrar::RegisterFunctions(Class, MakeConstArrayView(Z_Construct_UClass_UBlotterString_Statics::Funcs));
}
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, UBlotterString);
UBlotterString::~UBlotterString() {}
// ********** End Class UBlotterString *************************************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_InkpotDemo_Plugins_Inkpot_Source_InkpotEditor_Public_Blotter_BlotterString_h__Script_InkpotEditor_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UBlotterString, UBlotterString::StaticClass, TEXT("UBlotterString"), &Z_Registration_Info_UClass_UBlotterString, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBlotterString), 2345278624U) },
	};
}; // Z_CompiledInDeferFile_FID_InkpotDemo_Plugins_Inkpot_Source_InkpotEditor_Public_Blotter_BlotterString_h__Script_InkpotEditor_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_InkpotDemo_Plugins_Inkpot_Source_InkpotEditor_Public_Blotter_BlotterString_h__Script_InkpotEditor_1872818224{
	TEXT("/Script/InkpotEditor"),
	Z_CompiledInDeferFile_FID_InkpotDemo_Plugins_Inkpot_Source_InkpotEditor_Public_Blotter_BlotterString_h__Script_InkpotEditor_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_InkpotDemo_Plugins_Inkpot_Source_InkpotEditor_Public_Blotter_BlotterString_h__Script_InkpotEditor_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0,
};
// ********** End Registration *********************************************************************
